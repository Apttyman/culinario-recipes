    ...
    <div style={{ minHeight: "100vh", background: "var(--bg)", color: "var(--fg)" }}>
      ...
      <main className="culinario-page" style={{ paddingTop: 64, paddingBottom: 120, position: "relative" }}>
        ...
        <style>{`
          ...
          /*
            Share icon vertically centered on the right side of the pill.
            top: 50% + translateY(-50%) keeps it midpoint regardless of pill height.
            right: 22px sits safely inside the rounded edge of the pill (avatars
            are circular and reserve plenty of right-side space).
          */
          .duel-share {
            position: absolute;
            top: 50%;
