// Generate a photograph for a recipe via Lovable AI (Nano Banana).
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    }${recipe.chef_inspiration ? ` in the spirit of ${recipe.chef_inspiration}` : ""}. ` +
